...
public class ServerApi {
    //172.16.191.20//192.168.58.128
    public static String Login = "http://172.16.191.20:5000/api/Auth/Check";
    ...
    public static String GET_COMPLETE = "GetCompletedDispatchListItemsByEmployee";
